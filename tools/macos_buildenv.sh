...
if [ -n "${BUILDENV_ARM64}" ]; then
    BUILDENV_NAME="mixxx-deps-rel-2.4-arm64-osx-min1100-77335a6"
    BUILDENV_ID="828885953"
else
    BUILDENV_NAME="mixxx-deps-rel-2.4-x64-osx-min1012-77335a6"
    BUILDENV_ID="828885954"
fi
