...
if [ -n "${BUILDENV_ARM64}" ]; then
    BUILDENV_NAME="mixxx-deps-rel-2.4-arm64-osx-min1100-9947a27"
    BUILDENV_ID="831951536"
else
    BUILDENV_NAME="mixxx-deps-rel-2.4-x64-osx-min1012-9947a27"
    BUILDENV_ID="831951538"
fi
