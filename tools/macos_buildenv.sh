...
if [ -n "${BUILDENV_ARM64}" ]; then
    BUILDENV_NAME="mixxx-deps-rel-2.4-arm64-osx-min1100-release-717b9bc"
    BUILDENV_ID="1100522577"
else
    BUILDENV_NAME="mixxx-deps-rel-2.4-x64-osx-min1012-release-717b9bc"
    BUILDENV_ID="1100522578"
fi
