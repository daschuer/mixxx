...
if [ -n "${BUILDENV_ARM64}" ]; then
    BUILDENV_NAME="mixxx-deps-rel-2.5-arm64-osx-min1100-020b4c4"
    BUILDENV_ID="743552371"
else
    BUILDENV_NAME="mixxx-deps-rel-2.5-x64-osx-min1015-020b4c4"
    BUILDENV_ID="743552372"
fi
