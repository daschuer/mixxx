...
if [ -n "${BUILDENV_ARM64}" ]; then
    BUILDENV_NAME="mixxx-deps-2.6-arm64-osx-min1100-release-33c20d5"
    BUILDENV_ID="2970159632"
    VCPKG_TARGET_TRIPLET="arm64-osx-min1100-release"
else
    BUILDENV_NAME="mixxx-deps-2.6-x64-osx-min1100-33c20d5"
    BUILDENV_ID="2970215140"
