...
IF /I "%PLATFORM%"=="arm64" (
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_NAME=mixxx-deps-2.6-arm64-windows-rel-e82160b
        SET BUILDENV_SHA256=8c43893d2416c36e22f9ae3287f1594533041068cc4250ba46ab90994c552a76
    ) ELSE (
        SET BUILDENV_BRANCH=2.6
        SET VCPKG_TARGET_TRIPLET=arm64-windows
        SET BUILDENV_NAME=mixxx-deps-2.6-arm64-windows-4a1bc74
        SET BUILDENV_SHA256=65d192a12496f833077fc8e91a9cadc67fc3d36f77e0e85e46c6b96fb0be6759
    )
) ELSE IF /I "%PLATFORM%"=="x64" (
    IF DEFINED BUILDENV_RELEASE (
        SET BUILDENV_BRANCH=2.6-rel
        SET VCPKG_TARGET_TRIPLET=x64-windows-release
        SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-rel-e82160b
        SET BUILDENV_SHA256=124bc39c432ace8a4be8515862be728b610a6778e2934a14ad3aba6304e349fa
    ) ELSE (
        SET BUILDENV_BRANCH=2.6
        SET VCPKG_TARGET_TRIPLET=x64-windows
        SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-4a1bc74
        SET BUILDENV_SHA256=56ce3d666199bde345107f83b33a7154a965547f4cf7ea03dc9e8db3b493fb3e
    )
) ELSE (
