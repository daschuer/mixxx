...
:COMMAND_setup
    ...
    IF NOT EXIST "%BUILDENV_PATH%" (
        ...
        IF NOT EXIST "!BUILDENV_PATH!.zip" (
            ...
            curl.exe -o "!BUILDENV_PATH!_.zip" -L -H "authorization: token !TOKEN!" -H "Accept: application/vnd.github.v3+json" https://api.github.com/repos/daschuer/vcpkg/actions/artifacts/518915160/zip
