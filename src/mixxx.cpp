...
#ifdef __APPLE__
    // TODO: At this point it is too late to provide the same settings path to all components and too early to log errors and give users advises in their system language.
