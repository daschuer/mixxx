...
PipewireEnumerator::PipewireEnumerator(
        ...
        : m_pSoundManager(pManager),
          ...
          m_coMainVolume(ConfigKey("[Master]", "hwGain"), -32, 3.25, 2.0 / 3.0),
          m_coHeadVolume(ConfigKey("[Master]", "headHwGain"), -32, 3.25, 2.0 / 3.0),
          m_coBoothVolume(ConfigKey("[Master]", "boothHwGain"), -32, 3.25, 2.0 / 3.0),
